...
router.post('/getToken', function(req, res) {
  ...
  res.json({ 'qiniu_token': uploadToken, 'qiniu_key': filename, 'qiniu_url': 'http://chengshun.vnewcd.com/' + filename })
})
...
router.post('/getTokenNoName', function(req, res) {
  ...
  res.json({ 'qiniu_token': uploadToken, 'qiniu_key': uid, 'qiniu_url': 'http://chengshun.vnewcd.com/' + uid })
})
